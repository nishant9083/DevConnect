        ...
        <div className="space-y-6">
          {!isProfileComplete && (
            <Card className="border-yellow-200 bg-yellow-50 dark:border-yellow-900 dark:bg-yellow-950">
              ...
              <CardContent>
                <Button asChild>
                  <Link href="/profile?edit_profile=true">
                    Complete Profile
                  </Link>
                </Button>
              </CardContent>
              ...
              <Tabs defaultValue="discussions" className="w-full">
                ...
                <TabsContent value="discussions" className="space-y-4">
                  {discussions?.map((discussion) => (
                    <CardContent className="p-0 m-0 py-4 hover:bg-gray-700 rounded-md px-2" key={discussion.id}>
                      <div
                        key={discussion.id}
                ...
                <TabsContent value="events" className="space-y-4">
                  {events?.map((event) => (
                    <CardContent className="p-0 m-0 py-4 hover:bg-gray-700 rounded-md px-2" key={event.id}>
